    ...
    <main class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h3 class="card-title">Update How It Works</h3>
            </div>

            <div class="card-body">
                <form method="post" action="{{ route('howItWorksUpdate') }}">
                    @csrf
        ...
        <div class="card mt-4">
            <div class="card-header d-flex justify-content-between">
                <h3 class="card-title">All How It Works</h3>
                <!-- Add New Page Button -->
                <a href="{{ route('howItWorks.create') }}" class="btn btn-primary">
...
@push('script')
    ...
    <script>
        ...
        function changeStatus(event, id) {
            ...
            let statusUrl = '{{ route('howItWorksStatus', ':id') }}'.replace(':id', id);
        ...
        function deleteRecord(event, id) {
            event.preventDefault();
            let deleteUrl = '{{ route('howItWorks.destroy', ':id') }}'.replace(':id', id);
