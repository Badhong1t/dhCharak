...
@section('content')
    ...
    <section class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h3 class="card-title">Update How Delivery Works</h3>
            </div>

            <div class="card-body">
                <form method="post" action="{{ route('howDeliveryWorksUpdate') }}">
                    @csrf
    ...
    <section class="container-xxl flex-grow-1 container-p-y">
        <div class="card mt-4">
            ...
            <form method="post" action="{{ route('howDeliveryWorksImage.update') }}" enctype="multipart/form-data">
                @csrf
