    ...
    <main class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h3 class="card-title">Update Handling Frozen & Refrigerated Goods</h3>
            </div>

            <div class="card-body">
                <form method="post" action="{{ route('handlingFrozenGoodsUpdate') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div>
                        <div class="form-group">
                            ...
                            <input type="file" class="dropify @error('image') is-invalid @enderror" name="image"
                                id="image" data-default-file="{{ !empty($data->image) ? asset($data->image) : '' }}">
                            @error('image')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
        ...
        <div class="card mt-4">
            <div class="card-header d-flex justify-content-between">
                <h3 class="card-title">All Handling Frozen & Refrigerated Goods</h3>
                <!-- Add New Page Button -->
                <a href="{{ route('handlingFrozenGoods.create') }}" class="btn btn-primary">
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('handlingFrozenGoods.index') }}",
                        type: "get",
                    },
        ...
        function changeStatus(event, id) {
            ...
            let statusUrl = '{{ route('handlingFrozenGoodsStatus', ':id') }}'.replace(':id', id);
        ...
        function deleteRecord(event, id) {
            event.preventDefault();
            let deleteUrl = '{{ route('handlingFrozenGoods.destroy', ':id') }}'.replace(':id', id);
