    ...
    <main class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h3 class="card-title">Update, Why Choose Bulksail?</h3>
            </div>

            <div class="card-body">
                <form method="post" action="{{ route('whyChooseBulksailUpdate') }}">
                    @csrf
        ...
        <div class="card mt-4">
            <div class="card-header d-flex justify-content-between">
                <h3 class="card-title">All, Why Choose Bulksail?</h3>
                <!-- Add New Page Button -->
                <a href="{{ route('whyChooseBulksail.create') }}" class="btn btn-primary">
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('whyChooseBulksail.index') }}",
                        type: "get",
                    },
        ...
        function changeStatus(event, id) {
            ...
            let statusUrl = '{{ route('whyChooseBulksailStatus', ':id') }}'.replace(':id', id);
        ...
        function deleteRecord(event, id) {
            event.preventDefault();
            let deleteUrl = '{{ route('whyChooseBulksail.destroy', ':id') }}'.replace(':id', id);
