...
<<<<<<< HEAD
    ...
    <li class="menu-item {{ Request::routeIs('products.*') || Request::routeIs('attributes.*') || Request::routeIs('categories.*') || Request::routeIs('subcategories.*') ? 'active open' : '' }}">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
            <i class='menu-icon tf-icons bx bx-category-alt'></i>
          <div data-i18n="Layouts">Products</div>
        </a>
        <ul class="menu-sub">
          <li class="menu-item {{ Request::routeIs('products.create') ? 'active open' : '' }} ">
          ...
          <li class="menu-item {{ Request::routeIs('attributes.index') ? 'active open' : '' }}">
            <a href="{{ route('attributes.index') }}" class="menu-link">
              <div data-i18n="Container">Attributes</div>
            </a>
          </li>
            ...
            <li class="menu-item {{ Request::routeIs('subcategories.index') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="" class="menu-link">
                        <div data-i18n="Account">Delivery Details</div>
                    </a>
                </li>
                <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="" class="menu-link">
                        <div data-i18n="Notifications">Pickup Locations</div>
                    </a>
                </li>
                <li class="menu-item">
...
>>>>>>> 00c2411ee8b86af30da594146467a7d1e0f1cebd
...
<<<<<<< HEAD
    ...
    <li class="menu-item {{ Request::routeIs('profile.index') || Request::routeIs('system.index') || Request::routeIs('dynamicPages.*') ? 'active open' : '' }}">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
            <i class='menu-icon tf-icons bx bx-cog' ></i>
          <div data-i18n="Layouts">Settings</div>
        </a>
        <ul class="menu-sub">
          <li class="menu-item {{ Request::routeIs('profile.index') ? 'active open' : '' }}">
            <a href="{{ route('profile.index') }}" class="menu-link">
              <div data-i18n="Container">Profile Settings</div>
            </a>
          </li>
            <li class="menu-item {{ Request::routeIs('system.index') ? 'active open' : '' }}">
                <a href="{{ route('system.index') }}" class="menu-link">
                    <div data-i18n="Account">System Settings</div>
                </a>
            </li>
            <li class="menu-item {{ Request::routeIs('dynamicPages.index') ? 'active open' : ''  }}">
                <a href="{{ route('dynamicPages.index') }}" class="menu-link">
                    <div data-i18n="Notifications">Dynamic Page</div>
                </a>
            </li>
