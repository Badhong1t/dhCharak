...
class DynamicPageController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($data) {
                    ...
                    <button class="action-btn outline-action-btn" title="Edit" type="button" onclick="window.location.href=\'' . route('dynamicPages.edit', $data->id) . '\'">
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'page_content' => 'required|max:255|string',
    ...
    public function edit(string $id)
    {
        ...
        return view('backend.layouts.settings.dynamic_page.edit', compact('page'));
